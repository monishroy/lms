                ...
                <div class="content-header">
                    ...
                    <div class="leftside-content-header">
                        <ul class="breadcrumbs">
                            <li><i class="fa fa-book" aria-hidden="true"></i><a href="index.php">Dashboard</a></li>
                                        ...
                                        if($tamp > 0){
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)){
                                                    ...
                                                    <div class="col-sm-3 col-md-2">
                                                        <img style="width: 100px; height: 150px;" src="../images/books/<?= $row['book_image'] ?>" alt="">
                                                        <p><?= $row['book_name'] ?></p>
