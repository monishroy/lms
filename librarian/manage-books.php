                                ...
                                <table id="basic-table" class="data-table table table-striped nowrap table-hover table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                    <tr>
                                                        <td><?= $row['book_name'] ?></td>
                                                        <td><img style="width: 60px; height: 85px;" src="../images/books/<?= $row['book_image'] ?>" alt=""></td>
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="book_name">Book Name</label>
                                                                    ...
                                                                    <input type="hidden" class="form-control" id="id" name="id" value="<?= $book_info_row['id'] ?>" required>
                                                            </div>
                                                            <!-- <div class="form-group">
                                                                <label for="book_image">Book Image</label>
                                                                    <input type="file" id="book_image" name="book_image" required>
                                                                    <img style="width: 70px; hight: 90px;" src="../images/books/<?= $book_info_row['book_image'] ?>" alt="">
                                                            </div> -->
                                                            <div class="form-group">
                                                                <label for="book_author_name">Author Name</label>
                                                                    <input type="text" class="form-control" id="book_author_name" name="book_author_name" placeholder="Author Name" required value="<?= $book_info_row['book_author_name'] ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="book_publication_name">Publication Name</label>
                                                                    <input type="text" class="form-control" id="book_publication_name" name="book_publication_name" placeholder="Publication Name" required value="<?= $book_info_row['book_publication_name'] ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="book_purchase_date">Purchase Date</label>
                                                                    <input type="date" class="form-control" id="book_purchase_date" name="book_purchase_date" placeholder="Purchase Date" required value="<?= $book_info_row['book_purchase_date'] ?>">
                                                            </div>
                                                            <div class="form-group">
